...
<?php $__env->startSection('content'); ?>
  ...
  <div class="flex gap-2">
    ...
    <form method="POST" action="<?php echo e(route('tasks.status', ['task' => $task])); ?>">
      <?php echo csrf_field(); ?>
    ...
    <a href="<?php echo e(route('tasks.index')); ?>" class="btn">Back</a>
  </div>
<?php $__env->stopSection(); ?>

<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\xampp\htdocs\task-list\resources\views/show.blade.php ENDPATH**/ ?>